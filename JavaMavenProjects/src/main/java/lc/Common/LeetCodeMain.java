...
import lc.CodePad.*;
import lc.Lang.JavaCollectionEx;
import lc.Lang.JavaLang;
import lc.Lang.PeekingIteratorModule;
import lc.Question.*;
import lc.Unsorted.*;
import lc.languageTip.ReadWriteSample;
import lc.languageTip.ReflectionSample;
 ...
 */
public class LeetCodeMain implements Runnable{

  @Override
  public void run() {
      LeetCodeMain.main(null);
  }
